...
use PHPMailer\PHPMailer\SMTP; // 这里你之前写成了STMP
...
SELECT * FROM tbl_listings as l WHERE NOW() > end_date AND DATE_ADD(end_date, INTERVAL 30 MINUTE) AND l.listing_id = b.listing_id AND l.starting_price = b.biding_price
...
function smtpmailer($to, $from, $from_name, $subject, $body)
{
    ...
    $mail->Username   = "978338509@qq.com"; // 使用你自己的邮箱账号
    $mail->Password   = "imfsscrmdkcqbeci"; // 换成获取到的QQ邮箱授权码
    $mail->isHTML(true);
    /* Add a recipient. */
